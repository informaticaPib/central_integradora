<?php
    ...
    //echo '<pre>';print_r($idDiscipuladorPib);'</pre>';
	//dados da pessoa
...
<div class="row">
    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link" id="euvim-tab" data-toggle="tab" href="#euvim" role="tab" aria-controls="euvim" aria-selected="false">Eu vim</a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane fade show" id="euvim" role="tabpanel" aria-labelledby="euvim-tab">
                <ul class="nav nav-tabs nav-pills">
                    <li class="nav-item">
                        <a class="nav-link" id="euvim-tab-discipulado" data-toggle="tab" href="#euvimresult" role="tab" aria-selected="false" onclick="buscarEuVim(4)">Discipulado (<span id="totalEuVimDiscipulado"></span>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="euvim-tab-serigreja" data-toggle="tab" href="#euvimresult" role="tab" aria-selected="false" onclick="buscarEuVim(5)">Ser Igreja (<span id="totalEuVimSerIgreja"></span>)</a>
                    </li>
                </ul>
                <div class="tab-content">
...
<div class="row">
    <div class="col-md-3">
        ...
        <?php
            ...
            if($totalIgreja >= 60 || $totalDiscipulado >= 60){
                $idMembro = $dadosMembro['Clientepib']['id'];
                    echo '<button class="btn btn-info btnAcaoPerfilDiscipulo" data-toggle="modal" data-target="#enviarintegracaoliberado2" onclick=verificaDados('.$idMembro.');>ENVIAR PARA ENTREVISTA DA INTEGRAÇÃO</button>';
                    //echo '<button class="btn btn-info btnAcaoPerfilDiscipulo" data-toggle="modal" data-target="#enviarintegracaoliberado2" >ENVIAR PARA ENTREVISTA DA INTEGRAÇÃO</button>';
            }else{
                
                #se o status for igual a 27 então não precisa verificar campos obrigatórios da tbl de membros
                if($valorstatus== 27){
            ...
            if($idDiscipulador != 0 && $statusDiscipulado == 1){
            ...
            echo '<button class="btn btn-warning btnAcaoPerfilDiscipulo" data-toggle="modal" data-target="#alterarIntegracao">ALTERAR STATUS DE INTEGRAÇÃO</button>';
            echo '<button class="btn btn-default btnAcaoPerfilDiscipulo" data-toggle="modal" data-target="#definirtime">DEFINIR TIME</button>';
        ...
        <div class="card">
            <div class="row no-gutters">                
                <div class="card-body">
                    ...
                    <?php
                        if($nomeDiscipulador != '' && $statusDiscipulado == 1){
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Registar aula</h4>
            ...
            <div class="modal-body">
				...
				<?php
					echo $this->Form->create('Euvim', array(
						'url' => array('controller' => 'discipulados', 'action' => 'addfrequencia'),
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" required="required" name="data[Euvim][id_turma]" onchange="buscarAulas(this.value)">
                        ...
                        <option value="5">Ser igreja</option>
                        <option value="4">Discipulado</option>
                    </select>
...
<!-- Modal ALTERAR STATUS INTEGRAÇÃO -->
<div class="modal fade" id="alterarIntegracao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">ALTERAR STATUS DE INTEGRAÇÃO</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <p><b>Aqui você vai alterar o status de integração da pessoa</b></p>
				<?php
					echo $this->Form->create('discipulado', array(
						'url' => array('controller' => 'discipulados', 'action' => 'alterarintegracao'),
						'class' => 'form-horizontal'
					));
					echo $this->Form->input("id_membro", array("type" => "hidden", "value"=>$idPib));
					echo $this->Form->input("status_id", array("options" => array('2' => 'Frequentador (Não aparecerá na CI)', '26' => 'Ser Igreja', '27' => 'Batismo', '29' => 'Acompanhamento', '30' => 'Stand-by (Discípulo indisponível no momento)'),  "default"=>$statusDiscipulo, 'class' => 'form-control', 'label' => 'Status'));
					echo "<label id='labelObservacaoStatus' style='display: none;'>Observação</label>";
					echo $this->Form->input("observacao", array("type" => "textarea", "class"=>"form-control", "style" => 'display:none;', "label" => false));
                ?>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<?php
					echo $this->Form->create('discipulado', array(
						'url' => array('controller' => 'discipulados', 'action' => 'definirtime'),
						'class' => 'form-horizontal'
					));
					echo $this->Form->input("id_membro", array("type" => "hidden", "value"=>$idPib));
...
<!-- Modal ENVIAR INTEGRAÇÃO ANTES DE 60% -->
<div class="modal fade" id="enviarintegracao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">ENVIAR PARA ENTREVISTA</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <p><b>Está pessoa está sendo enviada para entrevista antes de completar 60% da classe igreja ou discipulado, portanto é necessário informar o motivo.</b></p>
				<?php
					echo $this->Form->create('discipulado', array(
						'url' => array('controller' => 'discipulados', 'action' => 'enviarentrevista'),
						'class' => 'form-horizontal'
					));
					echo $this->Form->input("id_membro", array("type" => "hidden", "value"=>$idPib));
					echo $this->Form->input("nome_membro", array("type" => "hidden", "value"=>$nome));
                ...
                <div>
                    ...
                    <small id="observacaoHelp" class="form-text text-muted">Campo obrigatório, por favor preencher.</small>
                </div>
            </div>
...
<!-- Modal ENVIAR INTEGRAÇÃO APÓS 60% -->
<div class="modal fade" id="enviarintegracaoliberado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">ENVIAR PARA ENTREVISTA</h4>
            ...
            <div class="modal-body">
                <p><b>Está pessoa está sendo enviada para entrevista pois JÁ COMPLETOU MAIS DE 60% da classe igreja ou discipulado.</b></p>
				<?php
					echo $this->Form->create('discipulado', array(
						'url' => array('controller' => 'discipulados', 'action' => 'enviarentrevistaliberado'),
						'class' => 'form-horizontal'
					));
                ...
                <div>
                    <label>Observações</label>
					<?php echo $this->Form->input('observacao', array('label' => false, 'class' => 'form-control', 'type' => 'textarea')); ?>
                    <small id="observacaoHelp" class="form-text text-muted">Campo não é obrigatório, mas caso deseja escrever alguma informação para entrevista pode usar.</small>
                </div>
            </div>
...
<!-- Modal ENVIAR INTEGRAÇÃO APÓS 60% -->
<div class="modal fade" id="enviarintegracaoliberado2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">ENVIAR PARA ENTREVISTA</h4>
            ...
            <div class="modal-body">
				...
				<?php
					...
					echo $this->Form->input("cpf_membro", array("type" => "hidden", "value"=>$cpf));
					echo $this->Form->input("email_membro", array("type" => "hidden", "value"=>$email));
                    echo $this->Form->input("idPessoaVinculador", array("type" => "hidden", "value"=>$this->Session->read('Auth.User.id')));
                    echo $this->Form->input("idPessoaVinculadorMembro", array("type" => "hidden", "value"=>$idDiscipuladorPib));
				?>
                <div>
                    <label>Observações</label>
					<?php echo $this->Form->input('observacao', array('label' => false, 'class' => 'form-control', 'type' => 'textarea')); ?>
            ...
            <div class="modal-footer" id='idDivModalEnviarEntrevista'>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
                <button type="submit" class="btn btn-success" id='idEnviaLiberacao'>Salvar</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
		<?php
			echo $this->Form->create('Discipulador', array(
				'url' => array('controller' => 'discipulados', 'action' => 'vinculardiscipulador'),
				'class' => 'form-horizontal'
			));
		?>
...
<script type="text/javascript">
    ...
    function buscarEuVim(idModulo){
        $.ajax({
            type:"POST",            
            url:"<?php echo $this->Html->url(array("controller" => "discipulados","action"=> "euvim"), true); ?>",
            ...
            success:function(data){
                ...
                if(idModulo == 4){
                    $("#totalEuVimDiscipulado").html(totalRespondido);
                }else{
                    $("#totalEuVimSerIgreja").html(totalRespondido);
                }
            }
        });
    }
    ...
    function buscarAulas(modulo){
        $.ajax({
            type:"POST",
            url:"<?php echo $this->Html->url(array("controller" => "discipulados","action"=> "buscaaulas"), true); ?>",
            data: 'modulo='+modulo,
            dataType: 'json',
            async: true,
            success:function(data){
    ...
    function verificaDados(id) {	
        $.ajax({
            type:"POST",
            url:"<?php echo $this->Html->url(array("controller" => "discipulados","action"=> "buscaInfosCompleta"), true); ?>",
            data: 'id='+id,
            dataType: 'json',
            async: true,
            success:function(data){

                var id                       =  data['Clientepib']['id'];
                var nome                     =  data['Clientepib']['nome'];
                var tiporelacionamento_id    =  data['Clientepib']['tiporelacionamento_id'];
                var dtCasamento              =  data['Clientepib']['dtCasamento'];

                var status_id                =  data['Clientepib']['status_id'];
                var dtConversao              =  data['Clientepib']['dtConversao'];
                var dtBatismo                =  data['Clientepib']['dtBatismo'];

                var data_nascimento          =  data['Clientepib']['data_nascimento'];
                var sNacionalidade           =  data['Clientepib']['sNacionalidade'];
                var sNaturalidade            =  data['Clientepib']['sNaturalidade'];               
                var cpf                      =  data['Clientepib']['cpf'];
                var telefone_1               =  data['Clientepib']['telefone_1'];
                var email                    =  data['Clientepib']['email'];
                var cep                      =  data['Clientepib']['cep'];
                var numero                   =  data['Clientepib']['numero'];
                var statusDiscipulado        = <?php echo $statusDiscipulado; ?>;

                var discipuladorCi           =  data['MembroVinculo']['discipulador_id'];

                var respCampos = '';
                //se o status = integraca então verifica  data de conversao e data de batismo
                if(status_id == 26){
                    if(!dtBatismo || dtBatismo=='0000-00-00'){
                        respCampos += 'Data de Batismo, ';
                    }
                    if(!dtConversao || dtConversao=='0000-00-00'){
                        respCampos += 'Data de Conversão, ';
                    }
                }
                //se o status = batismo então verifica somente a data de conversao
                if(status_id == 27){
                    if(!dtConversao || dtConversao=='0000-00-00' ){
                        respCampos += 'Data de Conversão, ';
                    }
                ...
                //se o status de relacionamento for = 23 então casado
                if(tiporelacionamento_id==23){
                    if(!dtCasamento || dtCasamento=='0000-00-00'){
                        respCampos += 'Data de Casamento, ';
                    }
                }
                if(tiporelacionamento_id==0){
                        respCampos += 'Estado Civíl, ';
                }

                if(!data_nascimento || data_nascimento =='0000-00-00' )    { respCampos += 'Data de nascimento, ';     }
                if(!sNacionalidade || sNacionalidade == 0)                 { respCampos += 'Nacionalidade , ';         }
                if(!sNaturalidade || sNaturalidade  == 0)                 { respCampos += 'Naturalidade , ';          }
                if(!cpf)                                                   { respCampos += 'CPF , ';                   }
                if(!telefone_1)                                            { respCampos += 'Telefone , ';              }
                if(!email)                                                 { respCampos += 'Email , ';                 }
                if(!cep)                                                   { respCampos += 'Cep , ';                   }
                if(!numero)                                                { respCampos += 'Número da residencia , ';  }
                
                //verifica se a pessoa possui status = 29 - Acompanhamento MD ou 30 - Stand-by 
                if( status_id == 30 || status_id == 29){
                    ...
                    var span = document.createElement("span");                                
                        span.innerHTML = 'Atenção o(a) discípulo(a) possui o status <strong> Acompanhamento MD </strong> ou <strong> Stand-by </strong> ';
                    var txt = 'Atenção';
                    swal({
                        title: "" + txt + "", 
                        content: span,
                ...
                //verifica se a pessoa possui um discipulador vinculado
                if(discipuladorCi=="" ||  discipuladorCi==0 || statusDiscipulado == 0){
                    var span = document.createElement("span");
                    span.innerHTML = 'Não é possível enviar para entrevista sem antes vincular a um discipulador. <br/> Verifique este detalhe.';
                    var txt = 'Atenção';
                        swal({
                            title: "" + txt + "", 
                            content: span,
                    ...
                    //verifica se todos os campos orbigatórios na central de membros estão preenchidos
                    if(respCampos){
                        //esconde os botoes para impedir a pessoa de clicar para enviar sem que esteja valido
                        $("#idDivModalEnviarEntrevista").hide();
                        
                            var span = document.createElement("span");                                
                            span.innerHTML = 'Olá, é necessário que o(a) <strong>' +nome+ '</strong> finalize o preenchimento dos dados obrigatórios na <strong>CENTRAL DO MEMBRO</strong> antes de ser enviado para a entrevista!<br/><br/> Os dados que faltam são: <strong>' +respCampos+ '</strong> <br/> Oriente-o(a) a acessar a central do membro e atualizar os dados cadastrais.Caso ele não tenha acesso a central do membro, <h5><span style="cursor:pointer; background-color:#28a745;" class="badge badge-success" onclick=enviarDadosUsuario('+id+')>CLIQUE AQUI</span></h5> para enviar um login e senha para ele(a).';                                        
                            var txt = 'Atenção';
                            swal({
                                title: "" + txt + "", 
                                content: span,
    ...
    function enviarDadosUsuario(id) {
        ...
        var retorno = "";
            ...
            $.ajax({
                type:"POST",
                url:<?php echo "'".$this->Html->url(array('controller' => 'entradas', 'action' => 'reenvioAcessoPessoasDisci1'), true)."'";  ?>,
                dataType: 'json',
                data:"id="+id,
                async: true,
